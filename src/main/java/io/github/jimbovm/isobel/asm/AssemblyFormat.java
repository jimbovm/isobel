...
public final class AssemblyFormat {
	...
	/**
	 * Return a given world as assembly, labelling its areas with the number of the
	 * world.
	 *
	...
	/**
	 * Return a map to the key data represented by the Scenario object and its
	 * fields
	 ...
	 * 
	 * @return          A {@link Map} of Strings to Strings holding the generated
	 *                  assembly
	 */
