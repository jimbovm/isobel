...
public final class ExitPointer extends PopulationActor {
	 ...
	 * @param  startPage       The page on which to spawn the player in the
	 *                         destination area.
	 * @param  activeFromWorld The minimum world from which the exit pointer is in
	 *                         effect.
	 * 
	 * @return                 An ExitPointer with the given parameters.
	 */
	public static ExitPointer create(
		final int x, final String destination, final int startPage, final int activeFromWorld) {
