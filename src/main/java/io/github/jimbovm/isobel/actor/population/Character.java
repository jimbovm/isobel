...
import io.github.jimbovm.isobel.bytecode.population.PopulationCommand;
import io.github.jimbovm.isobel.bytecode.population.PopulationCommand.CharacterId;
...
public final class Character extends PopulationActor implements YPlaceable {
	...
	public enum Type {
		...
		/**
		 * @deprecated In the original game, Piranha Plants are spawned automatically in
		 *             all pipes when the level is anything other than 1-1.
		 */
		@Deprecated @XmlEnumValue("PIRANHA_PLANT")
		...
		/** @deprecated Spawned only by the game engine itself. */
		@Deprecated @XmlEnumValue("FLYING_CHEEP_GENERATOR")
		...
		/** @deprecated Spawned only by the game engine itself. */
		@Deprecated @XmlEnumValue("FIREWORKS")
		FIREWORKS(CharacterId.FIREWORKS.getOpcode()),
		/** @deprecated Spawned only by the game engine itself. */
		@Deprecated @XmlEnumValue("BILL_GENERATOR")
		...
		/**
		 * A lift consisting of two platforms that move like scales. The ropes are
		 * spawned separately.
		 * 
		 * @see io.github.jimbovm.isobel.actor.geography.FixedExtensible
	 ...
	 * 
	 * @return              A new instance of <code>Character</code> with the given
	 *                      parameters.
	 */
